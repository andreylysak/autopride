...
@section('content')
<div class="container">
    <div class="login-title-logo"><a href="/" class="btn btn-default"><img src="http://voyager.localhost/public/site_img/logo.png" class="logo" alt="logo"></a></div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('postSignup') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Електронная почта') }}</label>
